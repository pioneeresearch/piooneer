...
export default function ChildrenEducationPlanner() {
  ...
  const [formData, setFormData] = useState({
    ...
    mobile: "",
    goal: "",
    calculatorType: "Children Education Planner",
  });
  ...
  const simulation = useMemo(() => {
    ...
    const futureCost =
      currentCost *
      Math.pow(1 + educationInflation / 100, yearsToGoal);
  ...
  const downloadPDF = () => {
    ...
    // SUMMARY BOXES
    const summary = [
      ["Child Current Age", `${childAge} Years`],
      ["Education Start Age", `${educationAge} Years`],
      ["Future Education Cost", formatNum(simulation.futureCost)],
      ...
      <main className="max-w-7xl mx-auto px-6 pt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {[
              ["Child Current Age", childAge, setChildAge],
              ["Education Start Age", educationAge, setEducationAge],
              ["Current Education Cost (₹)", currentCost, setCurrentCost],
              ["Education Inflation (%)", educationInflation, setEducationInflation],
